        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    <div class="item">
                        <img src="{{ asset('assets') }}/images/portfolio/portfolio_details/1_1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="{{ asset('assets') }}/images/portfolio/portfolio_details/1_2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="{{ asset('assets') }}/images/portfolio/portfolio_details/1_3.jpg" alt="">
                    </div>
                </div>
