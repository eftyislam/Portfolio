                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                @foreach ($abouts as $about)
                                    <tr>
                                        <td class="w-10px align-middle">{{ $about->id }}</td>
                                        <td class="align-middle">{{ $about->title }}</td>
                                        <td class="align-middle">{{ $about->header }}</td>
                                        <td class="align-middle">{{Str::limit(strip_tags($about->description),40)}}</td>
                                        <td class="align-middle">
                                            <a href="{{ url('about/edit/'.$about->id) }}"> <i class="far fa-lg fa-fw me-2 fa-edit"></i> </a>
                                            <a href="{{ url('about/delete/'.$about->id) }}" id="delete"> <i class="fas fa-lg fa-fw me-2 fa-trash" ></i></a>
