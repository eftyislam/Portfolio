            ...
            <div class="col-xl-12">
                <div class="row">
                    <div  class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <form  action="{{ route('about.store') }}" method="POST" class="forms-sample">
                                    @csrf
                                    <div class=" mb-3">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" name="header" class="form-control" id="header"  placeholder="Enter Your Header" >
                                        @error('header')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <textarea name="description" class="form-control" id="summernote" placeholder="Enter Your Description"></textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
