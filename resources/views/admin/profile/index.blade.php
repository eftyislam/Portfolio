                            ...
                            <tbody>
                                @foreach ($profiles as $profile)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $profile->get_in_touch }}</td>
                                        <td class="align-middle">{{ $profile->location }}</td>
                                        <td class="align-middle">{{ $profile->email }}</td>
                                        <td class="align-middle">{{ $profile->number }}</td>
                                        <td class="align-middle">{{ $profile->Freelance }}</td>
                                        <td class="align-middle">
