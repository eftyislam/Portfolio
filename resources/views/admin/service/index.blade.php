                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="w-80px h-80px d-flex align-items-center justify-content-center">
                                                <img alt="" class="mw-100 mh-100" src="{{ asset($service->service_img) }}">
                                            </div>
                                        </td>

                                        <td class="align-middle">{{ $service->service_title }}</td>
                                        <td class="align-middle">{{ $service->service_dec }}</td>
                                        <td class="align-middle">
                                            <a href="{{ url('service/edit/'.$service->id) }}"> <i class="far fa-lg fa-fw me-2 fa-edit"></i> </a>
                                            <a href="{{ url('service/delete/'.$service->id) }}" id="delete"> <i class="fas fa-lg fa-fw me-2 fa-trash" ></i></a>
